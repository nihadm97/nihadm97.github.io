...
class Experiences extends React.Component{
    ...
    state = {
        experiences: [
            {id: 1, type: 'education', time: '2016 - 2022', field: 'Bachelor degree of Mathematics and Informatics', location: 'PMF Sarajevo', description: 'Collaborate with creative and development teams on the execution of ideas.'},
        ]
    }
